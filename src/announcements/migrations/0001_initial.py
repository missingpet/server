        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.CharField(
                    default='Описание отсутствует', max_length=1000, verbose_name='Описание')),
                ('photo', models.ImageField(upload_to='announcements',
                                            verbose_name='Фотография животного')),
                ('announcement_type', models.IntegerField(choices=[
                 (1, 'Потеряно'), (2, 'Найдено')], default=1, verbose_name='Тип объявления')),
                ('animal_type', models.IntegerField(choices=[
                 (1, 'Собака'), (2, 'Кошка'), (3, 'Другое')], default=1, verbose_name='Тип животного')),
                ('address', models.CharField(blank=True, max_length=500,
                                             null=True, verbose_name='Место пропажи/находки')),
